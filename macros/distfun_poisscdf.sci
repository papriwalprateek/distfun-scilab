...
function p = distfun_poisscdf(varargin)
    ...
    //
    // Parameters
    //   x : a 1x1 or nxm matrix of doubles, the number of occurrences of events . x belongs to the set {0,1,2,3,.....}
    ...
    apifun_checkgreq("distfun_poisscdf",lambda,"lambda",2,1)
