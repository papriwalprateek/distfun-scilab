...
function p = distfun_geocdf(varargin)
    ...
    //
    // Parameters
    //   x : a 1x1 or nxm matrix of doubles, the number of Bernoulli trials after which the first success occurs. x belongs to the set {0,1,2,3,......}
    ...
    apifun_checkrange("distfun_geocdf",pr,"pr",2,0,1)
